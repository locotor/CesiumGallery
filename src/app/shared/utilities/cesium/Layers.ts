...
export default class Layers {
  ...
  setTianDiToken(token) {
    ...
    this.imageries[TianDi.VECTOR] = [new Cesium.WebMapTileServiceImageryProvider({
      ...
      url: 'http://t0.tianditu.com/vec_w/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=vec&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default&format=tiles&tk=' + this.tianDiToken,
    ...
    this.imageries[TianDi.IMAGE] = [new Cesium.WebMapTileServiceImageryProvider({
      url: 'http://t0.tianditu.com/img_w/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=img&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default&format=tiles&tk=' + this.tianDiToken,
